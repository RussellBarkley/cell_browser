...
:enumerator: 7b
One-hundred random images were chosen from the dataset and were reconstructed after each epoch. Interact with the index and epoch scrolls to assess the decoded images saved during training.
:::
